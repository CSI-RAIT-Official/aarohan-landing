...
// Memoized stat components to prevent re-renders
const StatItem = memo(({ stat, index }: { stat: any; index: number }) => (
  <motion.div
...
const BackgroundGlows = memo(() => (
  <>
    <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#008d76]/10 rounded-full blur-[120px] pointer-events-none -translate-x-1/2" />
    <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#008d76]/5 rounded-full blur-[120px] pointer-events-none translate-x-1/2" />
  </>
));
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          {/* Stats Grid - Optimized with reduced gap on mobile */}
